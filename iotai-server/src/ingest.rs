...
// ---------------------------------------------------------------------------
// CRC-16/CCITT-FALSE (reimplemented for std, matching iotai-sdk's encoder)
// ---------------------------------------------------------------------------
...
/// Metric type identifiers matching iotai-sdk.
...
mod tests {
    ...
    /// Build a valid chunk for testing, matching the iotai-sdk encoder format.
