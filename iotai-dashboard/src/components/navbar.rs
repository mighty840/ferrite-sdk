                ...
                div {
                    ...
                    div {
                        ...
                        div {
                            ...
                            span {
                                class: "text-iotai-300 text-sm ml-2",
                                "Dashboard"
                            }
                        }
                        div {
                    ...
                    div {
                        ...
                        div {
                            class: "relative",
                            span {
                                class: "absolute top-0 right-0 block h-2 w-2 rounded-full bg-green-400 ring-2 ring-iotai-900"
                            }
                            svg {
                        ...
                        div {
                            class: "h-8 w-8 rounded-full bg-iotai-500 flex items-center justify-center text-white text-sm font-medium",
                            "U"
                        }
                    }
                    // Mobile menu button
...
fn NavLink(to: Route, label: &'static str) -> Element {
    rsx! {
        Link {
            to: to,
            class: "text-gray-300 hover:bg-iotai-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150",
            "{label}"
        }
    }
}
