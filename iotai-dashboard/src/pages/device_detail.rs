...
use crate::api::types::*;
use crate::components::{MetricChart, FaultViewer, TraceViewer};
use crate::Route;
    ...
    rsx! {
        div {
            ...
            nav {
                ...
                Link {
                    to: Route::Devices {},
                    class: "text-iotai-600 hover:text-iotai-800",
                    "Devices"
                }
            ...
            div {
                ...
                div {
                    ...
                    div {
                        ...
                        div {
                            class: "h-14 w-14 rounded-xl bg-iotai-100 flex items-center justify-center",
                            svg {
                                class: "h-8 w-8 text-iotai-600",
                                fill: "none",
                                view_box: "0 0 24 24",
                                stroke: "currentColor",
                                stroke_width: "2",
...
fn TabButton(
    ...
    let classes = if is_active {
        "border-iotai-500 text-iotai-600 border-b-2 py-3 px-1 text-sm font-medium cursor-pointer"
    } else {
