...
/// Route definitions for the iotai dashboard.
    ...
    rsx! {
        div {
            ...
            div {
                ...
                Link {
                    to: Route::Dashboard {},
                    class: "inline-flex items-center px-4 py-2 bg-iotai-600 text-white rounded-lg hover:bg-iotai-700 text-sm font-medium transition-colors duration-150",
                    "Go to Dashboard"
                }
            }
        }
